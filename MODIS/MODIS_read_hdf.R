...
setwd("../MODIS_data/watervapor_others/")

#sds = get_subdatasets("MYD04_3K.A2019087.1635.061.NRT.hdf" )
#sds = get_subdatasets("MYD05_L2.A2019087.1335.061.NRT.hdf" )  #NAICE
#sds = get_subdatasets("MYD05_L2.A2019087.1340.061.NRT.hdf" )
...
#pdf(file="water_vapor_set3.pdf", width = 8, height = 6)
...
write.csv( rast_df, "water_vapor_data.csv")
...
pdf(file="water_vapor_set3_strp.pdf", width = 8, height = 6)
quilt.plot(striped_rast_df$x, striped_rast_df$y, striped_rast_df$vapor, nx = 900, ny=1500)#2030)
dev.off()

save(water_vapor_pred, file="pred_water_vapor_20190328.RData")
